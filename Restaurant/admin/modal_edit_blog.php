...
<hr>
    ...
    <div class="controls">
    <input name="id" value="<?php echo $row['Blog_ID']; ?>" type="hidden" id="inputEmail" placeholder="ID">
    <input name="title" value="<?php echo $row['Blog_Title']; ?>" type="text" id="inputEmail" placeholder="Blog Title">
    </div>
    </div>
    <div class="control-group">
    <label class="control-label" for="inputPassword">Content:</label>
    <div class="controls">
	<textarea rows="7" class="span8" placeholder="Write your blogs here..!" name="content"><?php echo $row['Blog_Content']; ?></textarea>  
    </div>
    </div>
	
		
	<input type="hidden" value="<?php echo $row['Photo']; ?>"  name="Photo" id="inputEmail"  placeholder="Photo">
	<div class="control-group">
